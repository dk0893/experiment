...
def main( args ):
    ...
    elif args.ope == "remote_tmp":
        
        proc = remote_tmp( args.adrs, args.port )
        print( proc )
...
def prologue_remote( adrs='127.0.0.1', port=15285 ):
...
def remote_tmp( adrs='127.0.0.1', port=15285 ):
...
def parse_args():
    ...
    parser.add_argument( '--adrs',  default=None,           help='input adrs of string' )
    parser.add_argument( '--port',  default=None, type=int, help='input port' )
